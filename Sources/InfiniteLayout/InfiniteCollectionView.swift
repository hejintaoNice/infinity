...
extension InfiniteCollectionView: UICollectionViewDataSource {
    ...
    private var multiplier: Int {
        print("infiniteSection % numberOfSections3---\(InfiniteDataSources.multiplier(estimatedItemSize: self.infiniteLayout.itemSize, enabled: false))")
        return InfiniteDataSources.multiplier(estimatedItemSize: self.infiniteLayout.itemSize, enabled: false)
    }
    ...
    public func numberOfSections(in collectionView: UICollectionView) -> Int {
        print("infiniteSection % numberOfSections1---\(InfiniteDataSources.numberOfSections(numberOfSections: delegateNumberOfSections, multiplier: multiplier))")
    ...
    public func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        let aaaa = InfiniteDataSources.numberOfItemsInSection(numberOfItemsInSection: delegateNumberOfItems(in: section),
                                                              numberOfSections: delegateNumberOfSections,
                                                              multiplier: multiplier)
        print("infiniteSection % numberOfSections2---\(aaaa)")
